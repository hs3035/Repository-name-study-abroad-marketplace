    ...
    <div className="min-h-screen bg-gray-50 px-6 py-10">
      <div className="mx-auto max-w-2xl space-y-8">
        ...
        {[
          ...
          {
            title: '3. 服务与付款',
            body: '学生通过平台向导师付款，资金由平台托管。导师完成服务并由学生确认后，平台扣除15%服务费，将剩余85%转入导师绑定的收款账户。学生在导师标记完成后48小时内可申请退款；超时自动确认，款项释放给导师。',
          },
          {
            title: '4. 退款政策',
            body: '导师标记服务完成后48小时内，学生可提交退款申请。平台将介入审核，根据实际情况决定退款比例。一旦款项已释放给导师，原则上不予退款，特殊情况由平台协调处理。详见《退款政策》。',
          },
          {
            title: '5. 禁止行为',
